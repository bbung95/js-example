(function () {
    ...
    class Chart {
        constructor(parent = "body", data = {}, { width, height, radius, colors }) {
            ...
            // this.canvas.onmousemove = (e) => this.showColor(e);
        ...
        //     var x = e.offsetX;
        //     var y = e.offsetY;
        //     var color = this.ctx.getImageData(x, y, 1, 1).data;
        ...
        drawlegends = () => {
            ...
            for (const [data, value] of this.datas) {
                this.label += `<span style="background-color : ${this.colors[index]}">${data}</span>`;
                index++;
            }
